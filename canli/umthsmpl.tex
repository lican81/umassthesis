...
\title{CMOS Compatible Memristor Arrays: Materials, Integration and Applications }
\author{Can Li}
\date{September 2018} % The date you'll actually graduate -- must be
                     % February, May, or September
\copyrightyear{2018}
\bachelors{B.Sc.}{Peking University}
\masters{M.Sc.}{Peking University}
%\priordoctorate{M.D.}{University of Never-never-land}
\committeechair{Qiangfei Xia}
%\cochairs{Qiangfei Xia}{}
\firstreader{J. Joshua Yang}
\secondreader{Subhransu Maji}
%\thirdreader{Bill Shepherd}
%\fourthreader{Mary Lamb}   % Optional
%\fifthreader{}            % Optional
%\sixthreader{}            % Optional
\departmentchair{Christopher V. Hollotr} % Uses "Department Chair" as the title. To
